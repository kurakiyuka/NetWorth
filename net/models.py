...
class NetModel(models.Model):
    ASSETS_CATEGORY_CHOICES = [('Cash', '现金'), ('Stocks', '股票'), ('Funds', '基金'), ('Near Cash', '类现金'), ('Insurance', '保险'), ('Credit', '信用卡'), ('Bonds', '债券'), ('Fixed', '定期理财'), ('Others', '其他理财')]
    ...
    # 资产账户分类
    assets_category = models.CharField(max_length = 100, choices = ASSETS_CATEGORY_CHOICES, default = 'Cash')
    # 资产 / 负债
    assets_type = models.CharField(max_length = 20, choices = ASSETS_TYPE_CHOICES, default = 'Assets')
    # 币种
    currency_type = models.CharField(max_length = 10, choices = CURRENCY_TYPE_CHOICES, default = 'RMB')
    # 汇率
